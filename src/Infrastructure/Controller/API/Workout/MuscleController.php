...
final class MuscleController extends AbstractAPIController
{
    ...
    public function getMany(Request $request, GenericGetManyUseCase $useCase, MuscleDataModelProviderGateway $providerGateway): MultipleObjectViewModel
    {
    ...
    public function getOneById(int $id, GenericGetOneByIdUseCase $useCase, MuscleDataModelProviderGateway $providerGateway): SingleObjectViewModel
    {
    ...
    public function createOne(Request $request, GenericCreateOneUseCase $useCase, MuscleDataModelFactory $dataModelFactory): SingleObjectViewModel
    {
    ...
    public function deleteOnById(int $id, GenericDeleteOneByIdUseCase $useCase, MuscleDataModelProviderGateway $providerGateway): JsonResponse
    {

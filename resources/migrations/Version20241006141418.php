 ...
 */
final class Version20241006141418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE EQUIPMENT (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, status VARCHAR(15) NOT NULL, UNIQUE INDEX UNIQ_97FACB6C5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE MOVEMENT (id INT AUTO_INCREMENT NOT NULL, primary_muscle_id INT DEFAULT NULL, name VARCHAR(150) NOT NULL, status VARCHAR(15) NOT NULL, UNIQUE INDEX UNIQ_32EE09BB5E237E06 (name), INDEX IDX_32EE09BBFFD46653 (primary_muscle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE MUSCLE (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, status VARCHAR(15) NOT NULL, UNIQUE INDEX UNIQ_3E9DE695E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

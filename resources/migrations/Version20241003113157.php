 ...
 */
final class Version20241003113157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE EXERCISE (id INT AUTO_INCREMENT NOT NULL, movement_id INT DEFAULT NULL, group_id INT DEFAULT NULL, INDEX IDX_68E94950229E70A7 (movement_id), INDEX IDX_68E94950FE54D947 (group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE EXERCISE_GROUP (id INT AUTO_INCREMENT NOT NULL, workout_id INT DEFAULT NULL, INDEX IDX_A472CC0CA6CCCFC9 (workout_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
